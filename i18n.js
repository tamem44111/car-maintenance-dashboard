...
const I18N = {
    ...
    dict: {
        ar: {
            ...
            'Service Type': 'نوع الصيانة',
            'Services Performed (select all that apply)': 'الصيانة المنفذة (اختر كل ما ينطبق)',
            'Oil Type (next change interval)': 'نوع الزيت (فترة التغيير القادمة)',
            'Regular': 'عادي',
            'Semi-synthetic': 'نصف تخليقي',
            'Full synthetic': 'تخليقي بالكامل',
            'Brake Pad Thickness (mm)': 'سماكة فحمات الفرامل (ملم)',
            'New pads are about 10-12 mm; replace at 3 mm. Logging this predicts wear far better than a fixed interval.': 'الفحمات الجديدة تقارب ١٠-١٢ ملم، وتُستبدل عند ٣ ملم. تسجيل هذا يتنبأ بالتآكل أفضل بكثير من فترة ثابتة.',
            'Mileage at Service (km)': 'العداد عند الصيانة (كم)',
            'Please select a date.': 'الرجاء اختيار التاريخ.',
            'Select at least one service.': 'اختر نوع صيانة واحداً على الأقل.',
            'Please add a car first.': 'أضف سيارة أولاً.',
            'No odometer reading yet - type the reading from the dashboard.': 'لا توجد قراءة عداد بعد — أدخل القراءة من لوحة القيادة.',
            'Estimated from {km} km on {d} - edit if you know the exact reading.': 'مُقدّرة من {km} كم بتاريخ {d} — عدّلها إذا كنت تعرف القراءة الدقيقة.',
            'Your latest confirmed odometer reading - edit if needed.': 'آخر قراءة عداد مؤكدة لديك — عدّلها عند الحاجة.',
            'What is it for? e.g. Spark plugs': 'لماذا؟ مثال: بواجي',
            'Remove this bill': 'حذف هذه الفاتورة',
            'Shop / store name': 'اسم الورشة / المحل',
            'Warranty months': 'الضمان بالأشهر',
            'Warranty km': 'الضمان بالكيلومترات',
