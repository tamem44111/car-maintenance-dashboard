...
const I18N = {
    ...
    dict: {
        ar: {
            ...
            'Car': 'السيارة',
            'Checked only — nothing was replaced': 'فحص فقط — لم يُستبدل شيء',
            'Kept as a record and any measurement still counts, but the schedule will not treat this as the work being done.': 'يُحفظ كسجل وأي قياس يُحتسب، لكن الجدول لن يعتبرها تنفيذاً للعمل.',
            'Reading Date': 'تاريخ القراءة',
            'Driving {p}% more than usual lately': 'تقود {p}% أكثر من المعتاد مؤخراً',
            'Your oil choice: {label}': 'اختيارك للزيت: {label}',
            'On {d} the odometer had not reached {km} km yet — a later record already reads {l} km. Check the reading, or leave it blank.': 'في {d} لم يكن العداد قد بلغ {km} كم بعد — سجل لاحق يقرأ {l} كم. تحقق من القراءة، أو اتركها فارغة.',
            'Later': 'لاحقاً',
            'Undo': 'تراجع',
            'Postponed': 'مؤجلة',
            'back on {d}': 'تعود في {d}',
            'postponed {n} times': 'أُجّلت {n} مرات',
            'Postpone {type}': 'تأجيل {type}',
            'This stays due. Postponing only changes when the app brings it up again.': 'تبقى مستحقة. التأجيل يغيّر فقط متى يذكّرك التطبيق بها.',
            'Next week': 'الأسبوع القادم',
            'Next month': 'الشهر القادم',
            'In three months': 'بعد ثلاثة أشهر',
            'Or pick a date': 'أو اختر تاريخاً',
            'Why? (optional)': 'السبب؟ (اختياري)',
            'e.g. waiting for payday': 'مثال: بانتظار الراتب',
            'Choose how long, or pick a date.': 'اختر المدة، أو حدد تاريخاً.',
            'Postponed. It comes back on {d}, and stays due until you log it.': 'تم التأجيل. تعود في {d}، وتبقى مستحقة حتى تسجّلها.',
            'Nothing logged here yet. Your running cost still uses the consumption estimate in Settings.': 'لا يوجد تسجيل هنا بعد. تكلفة التشغيل ما زالت تستخدم تقدير الاستهلاك من الإعدادات.',
            'Needs attention': 'يحتاج انتباهك',
            'Estimated. Last read {km} km on {d}, {n} days ago at about {r} km a day.': 'تقديري. آخر قراءة {km} كم بتاريخ {d}، قبل {n} يوم بمعدل {r} كم يومياً.',
            'Confirmed reading from {d}.': 'قراءة مؤكدة بتاريخ {d}.',
            'Update the odometer': 'حدّث العداد',
            'Enter a new reading': 'أدخل قراءة جديدة',
            'over {km} km': 'خلال {km} كم',
            'Fuel is estimated from your consumption setting, not from logged fill-ups.': 'الوقود مُقدّر من إعداد الاستهلاك، وليس من تعبئات مسجّلة.',
            'Plan a trip': 'خطط لرحلة',
            'How far are you going? Tick return for a round trip.': 'كم المسافة؟ اختر ذهاب وعودة للرحلة الكاملة.',
            'One-way distance (km)': 'مسافة الذهاب (كم)',
            'Return trip': 'ذهاب وعودة',
            'SAR': 'ريال',
            'L': 'لتر',
            '{km} km': '{km} كم',
            'fuel {a} + wear {b}': 'وقود {a} + تآكل {b}',
            'set your fuel figures to include petrol': 'أدخل بيانات الوقود ليشمل البنزين',
            '{type} is already overdue': '{type} متأخرة أصلاً',
            'Tyres run out during this trip': 'الإطارات تنتهي أثناء هذه الرحلة',
            '{type} falls due during this trip': '{type} تستحق أثناء هذه الرحلة',
            'about {km} km in': 'بعد حوالي {km} كم',
            'at {km} km': 'عند {km} كم',
            'Nothing falls due on this trip': 'لا شيء يستحق في هذه الرحلة',
            'based on what the app knows about this car': 'بناءً على ما يعرفه التطبيق عن هذه السيارة',
            'this check cannot see those — fill them in for a complete answer': 'هذا الفحص لا يراها — أكملها للحصول على إجابة كاملة',
            'Tires': 'الإطارات',
            'Tyres': 'الإطارات',
            'Tyres need replacing': 'الإطارات تحتاج استبدال',
            'Tyres are near the end of their life': 'الإطارات قاربت نهاية عمرها',
            'No tyre record': 'لا يوجد سجل إطارات',
            'add when they were fitted so wear and age can be tracked': 'أضف تاريخ التركيب ليتم تتبع التآكل والعمر',
            'tread wears with distance': 'المداس يتآكل بالمسافة',
            '{km} km on this set': '{km} كم على هذه المجموعة',
            '{km} km past the usual life': '{km} كم بعد العمر المعتاد',
            '{y} years old': 'عمرها {y} سنة',
            'about {d} days at your rate': 'حوالي {d} يوم بمعدل قيادتك',
            'No record yet': 'لا يوجد سجل بعد',
            'No record': 'لا يوجد سجل',
            'Not enough records': 'السجلات غير كافية',
            'scored on {a} of {b} items': 'محسوبة على {a} من {b} بنود',
            '{n} services have no record': '{n} صيانات بلا سجل',
            'the schedule cannot judge these until it knows when they were last done': 'لا يمكن للجدول تقييمها حتى يعرف متى نُفذت آخر مرة',
            'Fill in': 'أكمل',
            'Fill in what you know': 'أكمل ما تعرفه',
            'These have no record yet, so the schedule cannot judge them. Fill in whatever you remember — a rough date is far better than nothing. Leave a row blank to keep it unknown.': 'هذه بلا سجل بعد، فلا يستطيع الجدول تقييمها. أدخل ما تتذكره — تاريخ تقريبي أفضل بكثير من لا شيء. اترك الحقل فارغاً ليبقى غير معروف.',
            'km (optional)': 'كم (اختياري)',
            'Only fill the odometer if you actually know it. A guessed reading would distort the driving-rate estimate everything else depends on.': 'لا تدخل قراءة العداد إلا إذا كنت تعرفها فعلاً. القراءة المخمّنة تشوّه تقدير معدل القيادة الذي يعتمد عليه كل شيء.',
            'Every scheduled service already has a record.': 'كل صيانة مجدولة لديها سجل بالفعل.',
            '{n} added. The schedule can judge these now.': 'تمت إضافة {n}. يستطيع الجدول تقييمها الآن.',
            'Fuel': 'الوقود',
            'Not tracked': 'غير متتبع',
            'Consumption and price': 'الاستهلاك والسعر',
            'Monthly spend': 'المصروف الشهري',
            'Consumption (L/100km)': 'الاستهلاك (لتر/١٠٠ كم)',
            'Spend per month (SAR)': 'المصروف الشهري (ريال)',
            'Works out at': 'يساوي',
            'SAR/year': 'ريال/سنة',
            'based on {km} km a year': 'بناءً على {km} كم سنوياً',
            'That is unusually low for a petrol car — check the figure.': 'هذا منخفض بشكل غير معتاد لسيارة بنزين — تحقق من الرقم.',
            'That is unusually high — check the figure.': 'هذا مرتفع بشكل غير معتاد — تحقق من الرقم.',
            'Fuel is usually the largest running cost. Without it, cost per km counts only maintenance.': 'الوقود عادةً أكبر تكلفة تشغيل. بدونه، تكلفة الكيلومتر تحسب الصيانة فقط.',
            'Maintenance': 'الصيانة',
            'Fuel (est.)': 'الوقود (تقديري)',
            'Total': 'الإجمالي',
            'SAR/km': 'ريال/كم',
            'Running Cost': 'تكلفة التشغيل',
            'In {d}d': 'خلال {d} يوم',
            '{d}d overdue': 'متأخر {d} يوم',
            ...
            'Station': 'المحطة',
            'Optional': 'اختياري',
            'Date and odometer are required.': 'التاريخ وقراءة العداد مطلوبان.',
            'Reminder For': 'تذكير بـ',
            'Due Date': 'تاريخ الاستحقاق',
            'Due Mileage (km)': 'العداد عند الاستحقاق (كم)',
            'Please select a due date.': 'الرجاء اختيار تاريخ الاستحقاق.',
            'e.g. 7': 'مثال: ٧',
            'Date': 'التاريخ',
